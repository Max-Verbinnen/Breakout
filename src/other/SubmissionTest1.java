...
#		       
	...
	void testBreakoutStateNull() {
		assertThrows(IllegalArgumentException.class, 
				() -> facade.createBreakoutState(null,oneBlock,bottomRight,paddle) );
		assertThrows(IllegalArgumentException.class, 
				() -> facade.createBreakoutState(oneBall,null,bottomRight,paddle) );
		assertThrows(IllegalArgumentException.class, 
				() -> facade.createBreakoutState(oneBall,oneBlock,null,paddle) );
		assertThrows(IllegalArgumentException.class, 
				() -> facade.createBreakoutState(oneBall,oneBlock,bottomRight,null) );
	}
	
	@Test
	void testBreakoutStateNormal() {
		BreakoutState state = facade.createBreakoutState(oneBall,oneBlock,bottomRight,paddle);
